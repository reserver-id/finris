...
import { useAddTransaction } from "RSV/hooks/useAddTransaction";
      ...
      <nav className="fixed bottom-0 left-0 right-0 h-20 max-w-md mx-auto z-20">
        <div className="relative h-full bg-white/80 backdrop-blur-lg border-t border-slate-200">
          ...
          <div className="flex justify-around items-center h-full px-2">
            ...
            <NavItem path="/transactions" label="Riwayat" icon={ListIcon} />
            <div className="w-16">
              <button
            ...
            <NavItem path="/budget" label="Anggaran" icon={BudgetIcon} />
            <NavItem path="/settings" label="Pengaturan" icon={SettingsIcon} />
          </div>
        </div>
      </nav>
